...
config :ex_mon, ExMonWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "0xaQ1KYTF/2cYyGTY+ZGtpc+je2ykIDMNqqVMY/FOUc4TtlKWaQTCChRajUAORxl",
  render_errors: [view: ExMonWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: ExMon.PubSub,
  live_view: [signing_salt: "xu0UArMn"]
...
config :ex_mon, ExMonWeb.Auth.Guardian,
  issuer: "ex_mon",
  secret_key: "5qvYl87Fb1Tm0MV7+KgcQqvipjwaq6Fr8uRTVH360EmCJVX1Pny1vVpGVxtqcteI"
